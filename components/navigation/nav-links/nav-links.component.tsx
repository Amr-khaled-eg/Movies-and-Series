...
const NavLinks = ({ show, toggleShow }: NavLinksProps) => {
  ...
  return (
    <>
      <div
        className={show ? `${styles.blur} ${styles.blurOpened}` : styles.blur}
      ></div>
      <ul
        className={
          show
            ? `${styles.navLinksList} ${styles.navLinksListOpened}`
            : styles.navLinksList
        }
      >
        <Image
